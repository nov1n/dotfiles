...
hass-cli service call switch.turn_on --arguments entity_id=switch.desk_switch
...
hass-cli service call media_player.volume_set --arguments entity_id=media_player.marantz_cinema_70s,volume_level=0
