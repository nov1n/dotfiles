...
obj.__gc = function(t) t:stop() end
...
function obj.setDisplay(state)
  local result
  if state then
    result = obj.menuBarItem:setIcon(obj.icons.on)
  else
    result = obj.menuBarItem:setIcon(obj.icons.off)
  end
end

function obj.clicked() obj.setDisplay(hs.caffeinate.toggle("displayIdle")) end
